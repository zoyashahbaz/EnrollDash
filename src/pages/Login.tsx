...
import { LogIn, UserPlus, AlertCircle, Loader2, GraduationCap } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-primary overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-6">
            ...
            >
              Master Your <br />
              <span className="text-primary-foreground/80">College Data</span> <br />
              with Precision.
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, x: -20 }}
            ...
            >
              Analyze enrollments, predict trends, and make data-driven decisions with our state-of-the-art dashboard.
            </motion.p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <p className="text-sm text-white/60">
              Trusted by 50+ Colleges in Pakistan
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 lg:p-24 bg-card">
        <motion.div
          ...
          className="w-full max-w-[350px] space-y-8"
        >
          <div className="space-y-2 text-center lg:text-left">
            <h1 className="text-3xl font-bold tracking-tight">Log in</h1>
            <p className="text-sm text-muted-foreground">
              For security, please sign in to your account.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-4 text-center space-y-2">
                <p className="text-[13px] text-muted-foreground">
                  ...
                  <Link to="/signup" className="text-foreground hover:underline font-medium underline-offset-4">
                    Sign up
                  </Link>
                </p>
                <Link to="#" className="block text-[13px] text-muted-foreground hover:underline underline-offset-4">
                  Forgot password?
                </Link>
              </div>
            </form>
